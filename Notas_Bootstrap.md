...
## Notas curso Bootstrap Platzi

This notes harbor some relevants notes about Platsi Bootstrap course, available on  [`Curso Boostrap` branch](https://platzi.com/clases/1331-bootstrap/13122-la-grilla-de-bootstrap/). Click on hyperlink to view the course.
...
Layout -> Overview -> Containers. Son los comonentes más básicos y se requieren para crear las  grillas en bootstrap.

Las grillas usan contedores, filas y colunas. ***Cada fila tiene 12 columnas***

~~~bash
      <div class="row">
        <div class="col-3">   //col-3   ----> define el ancho
          Hola mundo1
        </div>
        <div class="col-9">   //col-9   ----> define el ancho
          Hola mundo2
        </div>
        <div class="col">
          Hola mundo3
...
La suma de "col" puede hacerse con un límite de 12 columnas. Al pasarce, la que no alcance se pondrá en la siguiente fila.


Se puede manejar de manera dinámica el acomodo de columnas.
~~~bash
      <div class="row">
        <div class="col-12 col-lg-9" style="background: blue;">   //col-12   ----> define el ancho normal   .... col-lg-9 ----> en pantallas largas pon 9 columnas
          Hola mundo1
        </div>
        <div class="col-12 col-lg-3" style="background: red;">   ////col-9   ----> define el ancho
          Hola mundo2
        </div>
        <div class="col">
          Hola mundo3
...
Respecto del reto 1 (Curso Bootstrap de platzi), se puede hacer un acomodo dinámico, respentando que el máximo número de columnas dentro de una fila, es 12.
